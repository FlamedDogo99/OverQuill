...
window.addEventListener('load', function(){
  if ( location.toString() === 'https://www.overleaf.com/project' ) return; // Don't load on the project selection page
  ...
  new Promise( (resolve)=>{
    ...
    div.className = 'toolbar-item'
    {
      ...
      btn.addEventListener( 'click', ()=> {
        chrome.runtime.sendMessage({open_options: true});
      });
